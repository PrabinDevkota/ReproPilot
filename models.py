...
class FailureType(StrEnum):
    ...
    dataset_provenance_issue = "dataset_provenance_issue"
    hyperparameter_search_bias = "hyperparameter_search_bias"
    baseline_unfairness = "baseline_unfairness"
    statistical_underpower = "statistical_underpower"
...
class CheckName(StrEnum):
    ...
    dataset_provenance_check = "dataset_provenance_check"
    hyperparameter_search_check = "hyperparameter_search_check"
    baseline_fairness_check = "baseline_fairness_check"
    statistical_significance_check = "statistical_significance_check"
    implementation_completeness_check = "implementation_completeness_check"
...
class ActionType(StrEnum):
    ...
    inspect_result_table = "inspect_result_table"
    inspect_dataset_card = "inspect_dataset_card"
    inspect_checkpoint = "inspect_checkpoint"
    search_artifacts = "search_artifacts"
    compare_claim_to_artifacts = "compare_claim_to_artifacts"
    audit_experiment_design = "audit_experiment_design"
    ...
    run_dataset_provenance_check = "run_dataset_provenance_check"
    run_hyperparameter_search_check = "run_hyperparameter_search_check"
    run_baseline_fairness_check = "run_baseline_fairness_check"
    run_statistical_significance_check = "run_statistical_significance_check"
    run_implementation_completeness_check = "run_implementation_completeness_check"
